...
<script type="text/javascript">
	...
	function checkNewPw() {
		...
		if($("#new_Password").val().includes(" ")) {
			$("#checkNewPw").show();
			$("#checkNewPw").append("Password cannot contain space characters.");
			newPw = false;
		}
		else if($("#new_Password").val().length < 6) {

			$("#checkNewPw").show();
			$("#checkNewPw").append("Password must be at least 6 characters");
			newPw = false;
		}
		else {
			$("#checkNewPw").hide();
	...
	function checkPw() {
		...
		if($("#new_Password").val() != $("#password").val()) {
			$("#checkPw").show();
			$("#checkPw").append("Passwords are not the same.");
			Pw = false;
		}
		else {
			$("#checkPw").hide();
					...
					<div class="col-lg-8 col-lg-offset-2 detailed">
						...
						<form role="form" id="myForm" class="form-horizontal" enctype="multipart/form-data" method="post" onsubmit="return false;">
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									<input type="password" placeholder="Current Password" id="old_Password" class="form-control" maxlength="50" onblur="checkOldPw()"> 
									<label id="checkOldPw" style="color:red; display:none;">Please check your password</label>
									<input type="password" placeholder="New password" id="new_Password" class="form-control" maxlength="50" onblur="checkNewPw()"> 
									<label id="checkNewPw" style="color:red; display:none;"></label>
									<input type="password" placeholder="Confirm new password" id="password" name="Password" class="form-control" maxlength="50" onblur="checkPw()">
									<label id="checkPw" style="color:red; display:none;"></label>
								</div>
							</div>
							<div class="form-group">
								<label class="col-lg-2 control-label">Birth</label>
							...
							<div class="form-group">
								...
								<div class="col-lg-6">
									<input class="form-control " style="width: 71%; display: inline" type="text" id="zipCode" name="ZipCode" placeholder="Zip code" value="${sessionScope.LoginInfo.zipCode}" readOnly /> 
									<input type="button" class="btn btn-theme" onclick="sample6_execDaumPostcode()" value="find zipCode"><br>
									<div style="margin-top: 3px;">
										<input class="form-control " style="display: inline-block" type=text id="Address1" placeholder="Adress" value="${sessionScope.LoginInfo.address1}" readOnly> 
										<input class="form-control " style="display: inline-block" type="text" id="Address2" value="${sessionScope.LoginInfo.address2}" placeholder="Detailed Address">
									</div>
								</div>
