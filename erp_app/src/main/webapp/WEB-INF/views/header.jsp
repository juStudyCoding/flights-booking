	...
	<aside>
		<div id="sidebar" class="nav-collapse ">
			...
			<ul class="sidebar-menu" id="nav-accordion">
				...
				<li class="mt"><a href="/tour"> <i class="fa fa-plane"></i> <span>Flights</span>
				</a></li>
				<li class="mt"><a href="/myTourList"> <i class="fa fa-list"></i> <span>My bookings</span>
				</a></li>
				<li class="mt"><a href="/notice"> <i class="fa fa-desktop"></i> <span>Support</span>
				</a></li>
...
<script type="application/javascript">
    ...
    $(document).ready(function() {
      ...
      var member_no="${sessionScope.LoginInfo.no}"
    });
